...
const headers = document.querySelectorAll("#player-stats th");
...
function applyFilters() {
    ...
    filteredData = data.filter(player => {
        ...
        const nameMatch = player.name.toLowerCase().includes(searchValue);
...
headers.forEach((header, index) => {
    ...
    header.addEventListener("click", () => {
        ...
        const keys = ["name", "team", "points", "rebounds", "assists"];
